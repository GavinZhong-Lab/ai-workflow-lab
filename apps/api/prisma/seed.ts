...
async function main() {
  ...
  const proMonthly = await prisma.subscriptionPlan.upsert({
    ...
    update: {
      ...
      paddleBasePriceId: 'pri_01ksa0wzx39e6mppybs7r2wmc8',
      paddlePerPersonPriceId: 'pri_01ksa10fgzttn55dmb0z09wsm7',
      currency: 'cny',
  ...
  const proYearly = await prisma.subscriptionPlan.upsert({
    ...
    update: {
      ...
      paddleBasePriceId: 'pri_01ksa14zrbh8fs9y4dnzcddpz5',
      paddlePerPersonPriceId: 'pri_01ksa1669kszk0gbbfxyfq59tj',
      currency: 'cny',
  ...
  const enterpriseYearly = await prisma.subscriptionPlan.upsert({
    ...
    update: {
      ...
      paddleBasePriceId: 'pri_01ksa18n3d65aqz5qygb9gfgen',
      paddlePerPersonPriceId: 'pri_01ksa19q63yg1xyk868eatwnms',
      currency: 'cny',
